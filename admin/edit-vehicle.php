...
<head>
	...
	<title>skate Rental Portal | Admin Edit skate Info</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit skate</h2>
...
<label class="col-sm-2 control-label">skate Title<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">skate Overview<span style="color:red">*</span></label>
<div class="col-sm-10">
