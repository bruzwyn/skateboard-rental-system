					...
					<div class="row">
						<section class="4u 6u(medium) 12u$(small)">
							...
							<ul class="alt">
								...
								<li><a href="https://code/">Code</a> </li>
							</ul>
						</section>
						<section class="4u 6u$(medium) 12u$(small)">
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
									<h3>Address</h3>
									ABC Road<br>
									<a href="https://code.org/">Code</a> 521126
								</li>
								<li>
									<h3>Mail</h3>
									<a href="#">kamu@gmail.com</a>
								</li>
								<li>
									<h3>Phone</h3>
									(000) 123-2310
					...
					<ul class="copyright">
						<li>&copy; 2017 BookMyBusTicket. All rights reserved. Brought To You By <a href="https://code.org/">Code</a></li>
