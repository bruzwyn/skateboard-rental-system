...
<title>skates Rental Portal</title>
<!--Bootstrap -->
...
<link rel="shortcut icon" href="assets/images/favicon-icon/logo.jpeg">
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find Your Perfect skateshoe</h1>
            <p>We have more than a thousand skates for you to choose. </p>
            <a href="#" class="btn">Read More <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="false"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>skate For You</span></h2>
    ...
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New skate</a></li>
        </ul>
      </div>
      <!-- Recently Listed New Cars -->
      <div class="tab-content">
        <div role="tabpanel" class="tab-panel active" id="resentnewcar">
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-balance-scale" aria-hidden="true"></i>999+</h2>
            <p>Used skates For Sale</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
...
{  ?>
        ...
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="assets/images/bckgrdskate.jpeg" alt="" /> </div>
