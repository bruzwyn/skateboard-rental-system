...
<title>skatesForYou - Responsive skates Dealer HTML5 Template</title>
<!--Bootstrap -->
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="mailto:bruce.koech@gmail.com"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
